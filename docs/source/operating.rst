[tssprojecttest1version1-4c74] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tssprojecttest1version1-4c74] container is NOT running**.

.. tip::
   You must have your [tssprojecttest1version1-4c74] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/saiyanshrestha/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45451  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='saiyanshrestha'  \-\-env DOCKERUSERNAME='saiyanshrestha'  \-\-env MQTTUSERNAME='saiyanshrestha'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   saiyanshrestha/tssprojecttest1version1-4c74-amd64 (https://hub.docker.com/r/saiyanshrestha/tssprojecttest1version1-4c74-amd64)
...
.. important::
   docker run -d -p 50361:50361 -p 37219:37219 -p 41719:41719 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssprojecttest1version1-4c74 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74 \-\-env GITUSERNAME=saiyanshrestha  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=50361  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=37219  \-\-env SOLUTIONVIPERVIZPORT=41719 \-\-env DOCKERUSERNAME='saiyanshrestha' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=45451 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='saiyanshrestha' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  saiyanshrestha/tssprojecttest1version1-4c74-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - saiyanshrestha/tssprojecttest1version1-4c74-amd64
...
[tssprojecttest1version1-4c74] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/saiyanshrestha/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/tssprojecttest1version1-4c74
...
.. important::
   https://tssprojecttest1version1-4c74.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=50361, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37565, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38729, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34479, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=32949, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39231, HPDEHOST=127.0.1.1, HPDEPORT=44995, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33375

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4069-tssprojecttest1version1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74, python-preprocess-8694-tssprojecttest1version1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74, python-ai-6658-tssprojecttest1version1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
