...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37593  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='saiyanshrestha'  \-\-env DOCKERUSERNAME='saiyanshrestha'  \-\-env MQTTUSERNAME='saiyanshrestha'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 38635:38635 -p 51701:51701 -p 45293:45293 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssprojecttest1version1-4c74 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74 \-\-env GITUSERNAME=saiyanshrestha  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=38635  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=51701  \-\-env SOLUTIONVIPERVIZPORT=45293 \-\-env DOCKERUSERNAME='saiyanshrestha' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=37593 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='saiyanshrestha' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  saiyanshrestha/tssprojecttest1version1-4c74-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38635, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35843, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39727, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39937, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43107, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35041, HPDEHOST=127.0.1.1, HPDEPORT=37851, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41709

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2885-tssprojecttest1version1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74, python-preprocess-8681-tssprojecttest1version1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74, python-ai-7674-tssprojecttest1version1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojecttest1version1-4c74, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
